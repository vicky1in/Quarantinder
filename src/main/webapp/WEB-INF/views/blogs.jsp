...
<%--		      <el-avatar :size="50" :src="user.avatar"></el-avatar>--%>
	...
	<script>
	    ...
	    methods: {
	      ...
	      submit(){
	        ...
	        .then(
			  ...
			  if(this.show_id == data.postId){
				  axios.get('/api/comments?postId=' + this.show_id)
						  .then(
								  res =>{
					  this.comments = res.data
					  console.log(this.comments);
			  ...
			  // console.log(this.show_id, data.postId)
	      ...
	      page(currentPage) {
	        const _this = this
	        axios.get(baseUrl + "/api/posts?userId=" + this.userid).then(res => {
	          // console.log('res', res)
	          this.blogs = res.data
